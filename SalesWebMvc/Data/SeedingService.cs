...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // DB has beem seeded(foi semeado)
            }
            ...
            Seller s1 = new Seller(1, "Paulo Ribeiro", "paulo@teste.com.br", new DateTime(1997, 8, 6), 1500.00, d1);
            Seller s2 = new Seller(2, "Sande Cristina", "sande@email.com", new DateTime(1997, 8, 7), 2000.00, d2);
            Seller s3 = new Seller(3, "Rosineia Almeida", "rosineia@gmail.com", new DateTime(1979, 9, 21), 1851.95, d3);
            Seller s4 = new Seller(4, "João Pedro", "jpedrinho@hotmail.com", new DateTime(2005, 05, 20), 2600.65, d4);
            Seller s5 = new Seller(5, "Paulo Cesar", "paulo@live.com", new DateTime(1971, 01, 15), 3000.85, d4);
            ...
            _context.SaveChanges(); //Salva e confirma a inserção dos dados
        }
    }
}
